...
1.  **Expand the synthetic test set to 20–30 notes and improve synthetic note quality.** Getting the non-PHI sensitive notes from Dr. Waters and then generating new synthetic ones would be a good next step
